    ...
    def run(self):
        ...
        while 1:
            ...
            for v in self.vertices:
                # Translate the point about X axis, then about Y axis, and finally about Z axis. (No rotation ,only translation)
            ...
            #self.xaccel, self.yaccel, self.zaccel = bno.read_accelerometer()
	    self.current_time = time.time()
